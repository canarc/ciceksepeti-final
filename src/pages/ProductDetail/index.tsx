  ...
  return (
    <Container>
      ...
      <Box padding="1.4rem" display="flex" flexDirection="column">
        ...
        {isPurchased && <Box sx={{ width: '23.5rem', height: '4.5rem', borderRadius: '0.8rem', marginTop: '3rem', backgroundColor: '#FFF0E2', fontSize: '1.8rem', fontWeight: 'bold', lineHeight: '4.5rem', color: '#FAAD60', textAlign: 'center', verticalAlign: 'center' }}>Bu Ürün Satışta Değil</Box>}
      ...
      <PurchaseModal
        ...
        onHide={(success: boolean) => {
          if (success) setIsPurchased(true);
